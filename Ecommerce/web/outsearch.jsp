...
PreparedStatement st=con.prepareStatement("SELECT * FROM PRODUCTS WHERE ID =? OR PNAME = ? OR CATEGORY = ?");
st.setString(1,n);
st.setString(2,n);
st.setString(3,n);
        ...
        <div class="card-deck text-dark">
            <%while (rs.next()){
                ...
                %>
                        ...
                        <div class="card card0 text-left w-50">
                          <div class="card-body">
                             <p><img class="card-img-top h-25 w-25" src="<%= z%>" alt="Card image cap"></p>
                            ...
                            <button type="submit" class="btn btn-primary text-capitalize" name="cart" ><i class="fa fa-shopping-cart"></i> Add to cart</button>
                            <button type="submit" class="btn btn-danger text-capitalize" name="wish" ><i class="fa fa-heart-o"></i> wishlist</button>
                          </div>
                        </div>
            ...
            <div class="text-center">
              ...
              <img src="https://i.pinimg.com/originals/20/d3/8b/20d38b1d0d3304dd80adc2e4029278ac.png" class="rounded w-75 h-75" alt="...">
