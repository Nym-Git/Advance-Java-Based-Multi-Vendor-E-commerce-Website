                        ...
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                <%
                                     ...
                                     {
                                %>
                                <div class="m-b-25"> <img src="<%= p%>" class="img-radius"> </div>
                                <%} else {%>
                                <div class="m-b-25"> <img src="https://img.icons8.com/bubbles/100/000000/user.png" class="img-radius"> </div>
                                <%}%>
                                <p>
                                <h6 class="f-w-600 text-capitalize"><%= f%> <%= l%></h6>
                                </p> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="card-block">
                                <h6 class="m-b-20 p-b-5 b-b-default text-dark text-center f-w-600">About You  <i class="fa fa-heart" aria-hidden="true"></i></h6>
                                <div class="row">
                                    <div class="col-sm-7">
                                        <p class="m-b-10 text-dark f-w-600">Email</p>
                                        <h6 class="text-muted f-w-400"><%= n%></h6>
                                    </div>
                                    <div class="col-sm">
                                        <p class="m-b-10 text-dark f-w-600">Phone</p>
                                        <h6 class="text-muted f-w-400"><%= rs.getString(2)%></h6>
                                    </div>
                                    <div class="col-sm">
                                        <p class="m-b-10 text-dark f-w-600">Address</p>
                                        <h6 class="text-muted f-w-400"><%= a%></h6>
                                    </div>
                                    
                                        </div>
                                    <div class=" small my-3"></div>
                                    <form action="logout">
                                    <input type="submit" value="Log Out" class="btn btn-danger btn-block py-2 font-weight-bold">
                                    </form>
