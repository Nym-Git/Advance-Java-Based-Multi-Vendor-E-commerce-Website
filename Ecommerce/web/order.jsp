...
.checked
    ...
    <div class="container">
        ...
        <div class="card-deck text-dark w-75">
            <%while (rs.next()){
                ...
                %>
                        ...
                        <div class="card card0 text-left">
                          <div class="card-body w-75">
                              <p><img class="card-img-top" src="<%= z%>" alt="Card image cap"></p>
                            ...
                            <a href="wishlist.jsp?id=<%=rs.getString(8)%>" class="btn btn-danger text-capitalize"><i class="fa fa-heart-o"></i> wishlist</a>
