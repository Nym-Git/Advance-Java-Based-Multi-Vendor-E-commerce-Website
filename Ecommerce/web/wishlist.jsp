...
{
     PreparedStatement st=con.prepareStatement("DELETE FROM WISHLIST WHERE EMAIL = ? AND ID = ? ");
                st.setString(1,n);
               ...
               out.println("<html><body><script>alert('Product Deleted Succesfully');</script></body></html>");
                }
}
                ...
                %>
                        ...
                        <div class="card card0 text-left h-25">
                          <div class="card-body">
                            ...
                            <a href="cart.jsp?id=<%=rs.getString(8)%>" class="btn btn-primary text-capitalize"><i class="fa fa-shopping-cart"></i> add to cart</a>
                            <a href="wishlist.jsp?di=<%=rs.getString(8)%>" class="btn btn-danger text-capitalize"><i class="fa fa-trash"></i> delete</a>
                          </div>
                        </div>
